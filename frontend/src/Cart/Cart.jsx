    ...
    <div className="cart-page">
        ...
        <div className="price-summary">
            ...
            <div className="summary-item">
                ...
                <p className="summary-value">₹{subTotal.toLocaleString('en-IN', {minimumFractionDigits: 2,maximumFractionDigits: 2 })}</p>
            </div>
            <div className="summary-item">
                <p className="summary-label">+ 18% GST</p>
                <p className="summary-value">₹{tax.toLocaleString('en-IN', {minimumFractionDigits: 2,maximumFractionDigits: 2 })}</p>
            </div>
            <div className="summary-item">
                <p className="summary-label">+ Shipping</p>
                <p className="summary-value">₹{shipping.toLocaleString('en-IN', {minimumFractionDigits: 2,maximumFractionDigits: 2 })}</p>
            </div>

            <div className="summary-item">
                <p className="summary-label">- Discount {subTotal > 2000?"(10%)":"(if any)"}</p>
                <p className="summary-value">₹{discount.toLocaleString('en-IN', {minimumFractionDigits: 2,maximumFractionDigits: 2 })}</p>
            </div>

            <div className="summary-total">
                <p className="summary-label">Total</p>
                <p className="summary-value">₹{total.toLocaleString('en-IN', {minimumFractionDigits: 2,maximumFractionDigits: 2 })}</p>
            </div>
